...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // can double jump? so do it
        {
            DoJump();
    ...
    // public function to bounce off an enemy's head when we stun them
